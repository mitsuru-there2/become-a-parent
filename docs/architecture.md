...
```text
React + TanStack Router（SPA）+ TanStack Form + 8bitcn + Motion
                 ↓ Nano Stores / 公開応答
              Service.execute
              ↙             ↘
