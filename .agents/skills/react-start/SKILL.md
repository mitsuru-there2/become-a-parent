...
- [start-core](https://github.com/TanStack/router/blob/8e164d28f9e9eb1a7301109230d7ece9817492a8/packages/start-client-core/skills/start-core/SKILL.md) — core Start concepts
- [router-core](https://github.com/TanStack/router/blob/8e164d28f9e9eb1a7301109230d7ece9817492a8/packages/router-core/skills/router-core/SKILL.md) — routing fundamentals
- [react-router](https://github.com/TanStack/router/blob/8e164d28f9e9eb1a7301109230d7ece9817492a8/packages/react-router/skills/react-router/SKILL.md) — React Router hooks and components
