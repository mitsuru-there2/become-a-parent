...
This skill covers the **server half** of authentication: session storage, cookie issuance, OAuth flow, password-reset hardening, CSRF, rate limiting. For the **routing half** (`_authenticated` layout, `beforeLoad` redirects, RBAC checks), see [router-core/auth-and-guards](https://github.com/TanStack/router/blob/8e164d28f9e9eb1a7301109230d7ece9817492a8/packages/router-core/skills/router-core/auth-and-guards/SKILL.md).
...
- [router-core/auth-and-guards](https://github.com/TanStack/router/blob/8e164d28f9e9eb1a7301109230d7ece9817492a8/packages/router-core/skills/router-core/auth-and-guards/SKILL.md) — the routing side: `_authenticated` layout, `beforeLoad`, `redirect`, RBAC checks.
